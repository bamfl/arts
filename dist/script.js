...
var caclScroll = function caclScroll(upSelector) {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var widthTop = document.body.scrollTop,
          hash = this.hash,
...
/* harmony default export */ __webpack_exports__["default"] = (caclScroll);
...
var dbGetStyles = function dbGetStyles() {
  var downloadBtn = document.querySelector('.button-db'),
...
var fileDragAndDrop = function fileDragAndDrop() {
  // drag *
  // dragend *
...
function forms() {
  var postForm = function postForm(form) {
    form.addEventListener('submit', function (event) {
      ...
      var isCyrillic = function isCyrillic(text) {
      ...
      if (form.length === 7) {
        ...
        if (!isNaN(form[1].value) && form[1].value.length === 11 && isCyrillic(form[0].value)) {
          fetch('./assets/server.php', {
            method: 'POST',
            body: JSON.stringify(Object.fromEntries(formData.entries()))
          }).then(function () {
...
var hoverArts = function hoverArts() {
  var artBlocsks = document.querySelectorAll('.sizes-block');
  artBlocsks.forEach(function (block) {
    var img = block.firstElementChild;
    block.addEventListener('mouseenter', function () {
      var src = img.getAttribute('src');
      img.setAttribute('src', "".concat(src.slice(0, -4), "-1.png"));
    });
    block.addEventListener('mouseleave', function () {
      var src = img.getAttribute('src');
      img.setAttribute('src', "".concat(src.slice(0, -6), ".png"));
    });
  });
};

/* harmony default export */ __webpack_exports__["default"] = (hoverArts);
...
var showMore = function showMore() {
  var moreStylesBtn = document.querySelector('.button-styles');
  moreStylesBtn.addEventListener('click', function () {
    document.querySelectorAll('.styles-2').forEach(function (item) {
